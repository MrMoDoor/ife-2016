require([
    ...
    'listPage',
    'storage'
], function($, Darken, Storage) {
    'use strict';
    
    var cus = function() {
        // 如果是移动设备而且还没跳转的时候，就跳转到相应的页面
        if (navigator.userAgent.match(/(iPhone|iPod|Android|ios|iPad)/i) && location.href !== "mobile.html") {
    ...
    var getMessage = function() {
        ...
        // 加载完毕！
        window.opener.postMessage('ready', 'http://127.0.0.1:3000');
